...
dateBase::dateBase(QString host_name, QString database_name)
{
    initialize();
...
void dateBase::close_connection()
{
    chat_data.close();
}
...
int dateBase::check_user_exist(QString name)
{
    QSqlQuery query;
